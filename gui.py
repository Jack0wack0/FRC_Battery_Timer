...
#hey fellas, if you trynna get it to work and the audio keeps
#crashing, this is probably what you need to change. 
song = AudioSegment.from_mp3("/Users/ur username/Downloads/confirm-ding.mp3")
song2 = AudioSegment.from_mp3("/Users/ur username/Downloads/negative-beep.mp3")
